...
function aparri(){
	...
	if(document.getElementById("c1").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//aparri//latest-aparri.gif"; 
...
function subic(){
	...
	if(document.getElementById("c2").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//subic//latest-subic.gif";
...
function tagaytay(){
	...
	if(document.getElementById("c3").checked == true){
		vImageURL= "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//tagaytay//latest-tagaytay.gif";
...
function virac(){
	...
	if(document.getElementById("c4").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//virac//latest-virac.gif";
...
function cebu(){
	...
	if(document.getElementById("c5").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//cebu//latest-cebu.gif";
...
function iloilo(){
	...
	if(document.getElementById("c6").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//iloilo//latest-iloilo.gif";
...
function hinatuan(){
	...
	if(document.getElementById("c7").checked == true){
		vImageURL = "http://api.meteopilipinas.gov.ph//tmp//d41d8cd98f00b204e9800998ecf8427e//hinatuan//latest-hinatuan.gif";
